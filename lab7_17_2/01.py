...
def main():
    try:
        ...
        # In interactive mode, this might be tricky, but we follow the C++ logic.
        # Assuming the user provides input via stdin as expected.
...
if __name__ == "__main__":
    # Note: For interactive use, print prompts first if needed, 
    # but sys.stdin.read() is used here for consistency with A* inputs.
    main()
